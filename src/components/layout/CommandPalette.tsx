...
export default function CommandPalette() {
    ...
    const commands = useMemo<Command[]>(
        () => [
            ...
            {
                id: "go-instagram",
                label: "Open Instagram Workspace",
                description: "Publish generated assets to Instagram using Meta Graph APIs",
                keywords: ["instagram", "meta", "reels", "feed", "publish"],
                hint: "Route",
                run: () => router.push("/content-studio/instagram"),
            },
            {
                id: "go-facebook",
                label: "Open Facebook Workspace",
                description: "Manage Facebook page publishing and recent posts",
                keywords: ["facebook", "meta", "page", "posts", "publish"],
                hint: "Route",
                run: () => router.push("/content-studio/facebook"),
            },
            {
                id: "go-x",
                label: "Open X Workspace",
                description: "Publish posts and media-backed updates to X",
                keywords: ["x", "twitter", "tweets", "posts", "publish"],
                hint: "Route",
                run: () => router.push("/content-studio/x"),
            },
            {
                id: "go-library",
